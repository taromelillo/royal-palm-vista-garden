  ...
  return (
    <section className='flex flex-col gap-10 my-10'>
      <div>
        ...
        <br />
        <p>
          For confirmation of booking, a non refundable (but can be re-booked as
          long as the date specified is available and within 3 days before your
          booked date) reservation fee of 500 PHP shall be collected. The amount
          will be deducted to the total booking fee upon check in. Can be paid
          thru g-cash or directly on site.
        </p>
      </div>
      <div>
        <h3 className='text-xl uppercase font-bold tracking-widest'>
